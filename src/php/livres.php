...
session_start();
$query2 = $pdo->prepare("SELECT * FROM livres");
$query2->execute();
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    ...
    <div class="boutique">
        <?php while ($livre = $query2->fetch()) {
            ...
            echo '<p>' . $livre['date_sortie'] . ' • ' . $livre['Nb_pages'] . ' pages</p>'; ?>
            <div class="icones-actions">
                <i class="fa-solid fa-heart"></i>
                <form action="Accueil.php" method="POST" style="display:inline;">
